...
struct GetStatusRequest: KoohiiRequest {
    ...
    let guestResult: String? = "{\"stat\":\"ok\",\"new_cards\":0,\"due_cards\":\(GuestData.dueIds.count),\"relearn_cards\":\(GuestData.studyIds.count),\"learned_cards\":\(GuestData.failedIds.count),\"dbg_generation_time\":\"2161\"}"
}
